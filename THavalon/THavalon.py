...
def run_THavalon( players, gameroom_array):
	...
	if "Merlin" in good_roles_in_game:
		...
		filename = "game" + str(gameroom) + "/" + player_name
	...
	if num_players == 9:
		...
		pelinor_filename = "game" + str(gameroom) + "/" + pelinor
		...
		questing_beast_filename = "game" + str(gameroom) + "/" + questing_beast
	...
	if (num_players >= 7): 
		...
		bonus_hijack_filename = "game" + str(gameroom) + "/" + bonus_ability_hijack 
